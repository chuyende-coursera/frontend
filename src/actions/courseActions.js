...
export const requestUpdateCoursesDash = (id, params) => ({
...
export const requestDeleteCourse = (id) => ({
  type: types.REQUEST_DELETE_COURSE,
  id,
});

export const deleteCourses = (status) => ({
  type: types.API_LOAD_DELETE_COURSE,
  status,
});
