export default {
  ...
  "app.user.validate.passwordmin": "mật khẩu phải có độ dài từ 6 ký tự trở lên",
  ...
  "app.user.validate.userNamepattern":
    "Tên đăng nhập phải là số điện thoại hoặc email",
  "app.user.validate.fullName": "Nhập họ và tên!",
  "app.user.validate.fullNamepattern":
    "Họ và tên có độ dài từ 3 đến 50 ký tự và phải là chữ",
  ...
  "app.user.validate.isUserNameApi":
    "Tài khoản api từ 3 đến 50 ký tự, bao gồm chữ,số và dấu _",
};
