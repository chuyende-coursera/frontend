export default {
  ...
  "app.user.login": "Đăng nhập tài khoản",
  "app.user.logout": "Đăng xuất tài khoản",
  "app.user.currentUser": "Lấy tài khoản hiện tại",
  "app.user.users": "Lấy danh sách tài khoản",
